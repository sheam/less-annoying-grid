import {IDataResult, IFieldFilter, IPagination, ISortColumn} from "../../grid";
...
export function getData(pagination: IPagination, sort: ISortColumn|null, filters: IFieldFilter[]): IDataResult<IData>
{
